...
- **TPA10 room temperature, humidity and proximity reporting recover correctly again.** The Android climate sensors now remain active long enough for the helper-backed CHT8305 readings to refresh, without bringing back the retired duplicate Home Assistant entities. The continuously streaming proximity sensor no longer gets disrupted by periodic on-change re-registration; a genuinely stalled stream still enters bounded recovery immediately.
