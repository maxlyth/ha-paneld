...
- **"Idle return to home" now actually saves** — the setting rendered on the Configure tab but its value was silently never persisted, so the idle return never armed.
