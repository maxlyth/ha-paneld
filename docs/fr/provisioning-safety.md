> [!IMPORTANT]
> Ce document est généré automatiquement et fait l’objet d’une vérification croisée automatique, mais il n’a pas été systématiquement relu par des locuteurs de cette langue. La documentation en anglais fait foi. [Consulter la source en anglais](../provisioning-safety.md) ou [signaler une correction de traduction](https://github.com/maxlyth/ha-paneld/issues/new?template=translation_correction.yml).

# Sécurité et récupération du provisionnement

Cette page présente les contrôles et les limites de récupération qui sous-tendent le programme d’installation et l’outil de mise à jour du parc de ha-paneld. La plupart des utilisateurs n’ont besoin que des commandes figurant dans [Provisionnement et mises à jour du parc](provisioning.md). Les détails fournis ici s’adressent à toute personne qui cherche à déterminer si une mise à jour sans intervention est suffisamment sûre pour ses panneaux ou à diagnostiquer la raison pour laquelle le programme d’installation s’est arrêté.

## Limites relatives à la confiance et aux identifiants
...
## Authentification des versions publiées et des paquets
...
## Instantané automatique de la base de données
...
## Contrôles du fuseau horaire et de la première installation
...
## Transaction de mise à niveau de l’utilitaire root
...
## Limites des mises à jour du parc
...
## Causes possibles d’arrêt d’une exécution
