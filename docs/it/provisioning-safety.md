> [!IMPORTANT]
> Questo documento è generato automaticamente e verificato mediante controlli incrociati automatici, ma non è stato rivisto sistematicamente da persone che parlano questa lingua. La documentazione in inglese fa fede. [Leggi la fonte in inglese](../provisioning-safety.md) oppure [apri una segnalazione per correggere la traduzione](https://github.com/maxlyth/ha-paneld/issues/new?template=translation_correction.yml).

# Sicurezza e ripristino del provisioning

Questa pagina descrive i controlli e i limiti di ripristino su cui si basano il programma di installazione e lo strumento di aggiornamento del parco dispositivi di ha-paneld. Alla maggior parte degli utenti servono soltanto i comandi disponibili in [Provisioning e aggiornamenti del parco dispositivi](provisioning.md). I dettagli qui riportati sono destinati a chi deve stabilire se un aggiornamento non presidiato sia sufficientemente sicuro per i propri pannelli o diagnosticare il motivo per cui il programma di installazione si è arrestato.

## Limiti relativi all'attendibilità e alle credenziali
...
## Autenticazione delle release e dei pacchetti
...
## Snapshot automatico del database
...
## Controlli sul fuso orario e sulla prima installazione
...
## Transazione di aggiornamento dell'helper root
...
## Limiti degli aggiornamenti del parco dispositivi
...
## Condizioni che possono interrompere un'esecuzione
