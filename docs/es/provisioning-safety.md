> [!IMPORTANT]
> Este documento se genera automáticamente y se somete a comprobaciones cruzadas automáticas, pero no ha sido revisado sistemáticamente por hablantes de este idioma. La documentación en inglés es la fuente de referencia. [Consulta la fuente en inglés](../provisioning-safety.md) o [abre una incidencia para corregir la traducción](https://github.com/maxlyth/ha-paneld/issues/new?template=translation_correction.yml).

# Seguridad y recuperación del aprovisionamiento

Esta página recoge las comprobaciones y los límites de recuperación del instalador y del actualizador de flotas de ha-paneld. La mayoría de los usuarios solo necesitan los comandos de [Aprovisionamiento y actualizaciones de flota](provisioning.md). Esta información detallada está destinada a quienes necesiten decidir si una actualización desatendida es suficientemente segura para sus paneles o diagnosticar por qué se ha detenido el instalador.

## Límites de confianza y credenciales
...
## Autenticación de versiones y paquetes
...
## Instantánea automática de la base de datos
...
## Comprobaciones de zona horaria y primera instalación
...
## Transacción de actualización del asistente root
...
## Límites de las actualizaciones de flota
...
## Qué puede detener una ejecución
