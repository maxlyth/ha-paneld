...
- [`minimal-community.yaml`](minimal-community.yaml) is a conservative, standard-Android starting point. It enables no vendor protocol, root/helper path, relay, evdev input, update artifact or package-taming default.
