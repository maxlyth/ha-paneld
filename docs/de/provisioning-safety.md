> [!IMPORTANT]
> Dieses Dokument wurde maschinell erstellt und automatisch gegengeprüft, jedoch nicht systematisch von Personen geprüft, die diese Sprache sprechen. Die englische Dokumentation ist maßgeblich. [Englisches Original lesen](../provisioning-safety.md) oder [ein Issue zur Übersetzungskorrektur öffnen](https://github.com/maxlyth/ha-paneld/issues/new?template=translation_correction.yml).

# Sicherheit und Wiederherstellung bei der Bereitstellung

Diese Seite dokumentiert die Prüfungen und Wiederherstellungsgrenzen des Installationsprogramms und des Flotten-Updaters von ha-paneld. Die meisten Benutzer benötigen lediglich die Befehle unter [Bereitstellung und Flottenaktualisierungen](provisioning.md). Die Einzelheiten hier richten sich an alle, die entscheiden müssen, ob eine unbeaufsichtigte Aktualisierung für ihre Panels sicher genug ist, oder untersuchen möchten, warum das Installationsprogramm angehalten hat.

## Grenzen für Vertrauen und Anmeldedaten
...
## Authentifizierung von Releases und Paketen
...
## Zeitzonen- und Erstinstallationsprüfungen
...
## Upgrade-Transaktion des Root-Helfers
...
## Grenzen für Flottenaktualisierungen
...
## Was einen Vorgang stoppen kann
