...
|---|---|
| <a href="../img/ui-dashboard-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-dashboard-light.png"><img src="../img/ui-dashboard-dark.png" alt="Registerkarte „Dashboard“" width="420"></picture></a> | <a href="../img/ui-configure-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-configure-light.png"><img src="../img/ui-configure-dark.png" alt="Registerkarte „Konfigurieren“" width="420"></picture></a> |

| Entitäten | Installieren |
|---|---|
| <a href="../img/ui-entities-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-entities-light.png"><img src="../img/ui-entities-dark.png" alt="Registerkarte „Entitäten“" width="420"></picture></a> | <a href="../img/ui-install-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-install-light.png"><img src="../img/ui-install-dark.png" alt="Registerkarte „Installieren“" width="420"></picture></a> |

| Profil | Protokolle |
|---|---|
| <a href="../img/ui-profile-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-profile-light.png"><img src="../img/ui-profile-dark.png" alt="Registerkarte „Profil“" width="420"></picture></a> | <a href="../img/ui-logs-light.png"><picture><source media="(prefers-color-scheme: light)" srcset="../img/ui-logs-light.png"><img src="../img/ui-logs-dark.png" alt="Tab „Protokolle“" width="420"></picture></a> |
...
| ZHICAI SMT1019 | Von der Community getestet, einige Funktionen sind experimentell | Android 14, arm64-v8a | rk3576; die Standard-Firmware bietet keinen für Apps zugänglichen Root-Zugriff. Der authentifizierte Hilfsdienst kann, sofern installiert, zusätzlichen Hardwarezugriff ermöglichen. Die Genauigkeit der Klimasteuerung und die Unterstützung des Näherungssensors müssen noch weiter an der Hardware getestet werden. [Issue #8](https://github.com/maxlyth/ha-paneld/issues/8) |
| ZX-SMT156 / RK3566_T | Vorläufig | Android 13, arm64-v8a | RGB-LED sowie Licht- und Näherungssensor funktionieren ohne Root-Zugriff. Die Unterstützung der Klimasteuerung ist optional; Relais und Root-Zugriff werden noch genauer untersucht. [Issue #24](https://github.com/maxlyth/ha-paneld/issues/24) |
...
| Dashboard-Steuerung und Neustart | Home Assistant-Schaltflächen sowie Dashboard-, Reload- und Navigationsaktionen im entfernten Controls-Bedienfeld |
| TTS- und Durchsageaudio | `POST /play` und `number.<panel>_volume`; siehe die [TTS-Anleitung](../tts.md) |
| Dashboard-Screenshot und entferntes Tippen | Panels mit einer unterstützten Screenshot-Methode können den Bildschirm auf der Registerkarte Dashboard anzeigen und aktualisieren; im entspannten Modus kann außerdem ein Tippen an das Panel zurückgesendet werden |
...
### Gehärteter Sicherheitsmodus

Der entspannte Modus ist die Standardeinstellung und für ein vertrauenswürdiges Heimnetzwerk vorgesehen. Verwende den [gehärteten Sicherheitsmodus](../security-mode.md) , wenn weniger vertrauenswürdige Geräte dasselbe Netzwerk nutzen. Der gehärtete Sicherheitsmodus erfordert physischen Zugriff auf das Panel. Entfernte Aktionen mit weitreichenden Auswirkungen müssen von jemandem auf dem Bildschirm des Panels genehmigt werden; eine entfernte Genehmigung ist nicht möglich. Screenshots bleiben sichtbar, aber entferntes Tippen ist deaktiviert. Die Einstellung muss auf jedem Panel separat aktiviert werden und wird weder durch Sicherung und Wiederherstellung noch durch die Flottenbereitstellung kopiert.
...
**Kein Root-Zugriff erforderlich:** Kopplung mit Home Assistant, Bildschirmhelligkeit und Dimmen, Audiodurchsagen, beide Dashboard-Optionen, die Weboberfläche, die REST API sowie Sicherung und Wiederherstellung der Konfiguration. Zurück, Übersicht, Aufwecken durch Winken und die Software-Navigationsleiste hängen von der jeweiligen Android- oder Sensorfunktion ab, benötigen aber nicht grundsätzlich Root-Zugriff.
...
- [Sicherheitsmodi](../security-mode.md): den Modus Relaxed und den Sicherheitsmodus Hardened verstehen, einschließlich der Aktionen, für die jemand am Panel anwesend sein muss.
...
- **HTTP und Home Assistant WebSocket:** [Ktor](https://github.com/ktorio/ktor) .
